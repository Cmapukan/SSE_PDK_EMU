...
public:
	...
	virtual IClientInventory *GetIClientInventory( HSteamUser hSteamUser, HSteamPipe hSteamPipe, char const* pchVersion ) = 0;
	virtual IClientVR *GetIClientVR( int32, char const * pchVersion ) = 0;
	virtual IClientGameNotifications *GetIClientGameNotifications( HSteamUser hSteamUser, HSteamPipe hSteamPipe, char const* pchVersion ) = 0;
	virtual IClientHTMLSurface *GetIClientHTMLSurface( HSteamUser hSteamUser, HSteamPipe hSteamPipe, char const* pchVersion ) = 0;
	virtual IClientVideo *GetIClientVideo( HSteamUser hSteamUser, HSteamPipe hSteamPipe, char const* pchVersion ) = 0;
