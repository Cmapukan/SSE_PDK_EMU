...
public:
	...
	virtual FriendsGroupID_t GetFriendsGroupIDByIndex(int groupIndex) = 0;
	virtual const char * GetFriendsGroupName(FriendsGroupID_t friendGroupID) = 0;
	virtual int GetFriendsGroupMembersCount(FriendsGroupID_t friendGroupID) = 0;
	virtual void GetFriendsGroupMembersList(FriendsGroupID_t friendGroupID, CSteamID *pMembersOut, int nMembersCountMax ) = 0;
